...
import { Printer, ShieldCheck, QrCode, CheckCircle, FileSignature, AlertTriangle } from 'lucide-react';
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[680px] bg-slate-900 border-slate-800 text-slate-100 max-h-[90vh] overflow-y-auto">
        ...
        {/* Printable Area */}
        <div className="bg-white text-slate-900 p-6 sm:p-8 rounded-lg shadow-inner font-mono text-xs space-y-4 border border-slate-300 print:p-0 print:border-none print:shadow-none print:text-black">
